...
(55, 'R100', 'F100', 1, 'aesd', 'Plumber', 'S200', 1945344268, 123),
(69, 'R100', 'F100', 0, 'asfas', 'Cleaner', NULL, NULL, 1111);
...
('R100', 'T100 has left the flat (Flat No: F2)'),
('R100', 'T100 has paid the rent of F2 for February'),
('R100', 'T100 has paid the rent of F2 for January'),
('R100', 'Your maintainance request (Request ID: 1) has been accepted by the staff'),
('R100', 'Your maintainance request (Request ID: 2) has been accepted by the staff'),
('R100', 'Your maintainance request (Request ID: 4) has been accepted by the staff'),
('R100', 'Your maintainance request (Request ID: 423) has been accepted by the staff'),
('R100', 'Your maintainance request (Request ID: 55) has been accepted by the staff');
...
('4', '111', 'as', 'Utility Technician', 122),
('5', '111', 'as', 'Utility Technician', 122),
('S1', '123', 'Niloy', 'Painter', 1234),
...
--
ALTER TABLE `maintainence_request`
  ADD CONSTRAINT `maintainence_request_ibfk_1` FOREIGN KEY (`Flat_ID`) REFERENCES `apartment_a1` (`Flat_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `maintainence_request_ibfk_2` FOREIGN KEY (`Resident_ID`) REFERENCES `resident` (`Resident_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `maintainence_request_ibfk_3` FOREIGN KEY (`a_staff_id`) REFERENCES `service_and_utility_staff` (`Staff_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
