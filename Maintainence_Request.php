		...
		if ($result1->num_rows > 0) {
			while ($row1 = $result1->fetch_assoc()) {
				if ($row1['O_Flat_ID']=== $Flat_ID && $row1['T_Flat_ID']==NULL) {
					$flag1=1;
					$sql = "INSERT INTO maintainence_request (Request_ID,Status,Request_description,Required_role)
					VALUES ('$Request_ID', 0,'$Request_description', '$Required_role');";
					$sql .= "INSERT INTO makes (M_Resident_ID,M_Request_ID)
					VALUES ('$Resident_ID','$Request_ID');";
					$sql .= "INSERT INTO can_have (C_Flat_ID, C_Request_ID)
					VALUES ('$Flat_ID', '$Request_ID')";
